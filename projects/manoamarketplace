...
Manoa Marketplace is a web application that I helped create as a team project in ICS 314, Spring 2023. The project helped me learn how to design and implement a responsive web site.

Vacay is implemented using [Meteor](http://meteor.com), a JavaScript application platform. Within three weeks, we created a fully functional website that allows students to create listings for items they'd like to sell or inversely for buyers to get in contact with sellers.
